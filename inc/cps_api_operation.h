 ...
 */
ds_return_code_t cps_api_get_request_init(cps_api_get_params_t *req);
 ...
 * @return db return code
 */
ds_return_code_t cps_api_get_request_close(cps_api_get_params_t *req);
 ...
 */
ds_return_code_t cps_api_get(cps_api_get_params_t * param);
 ...
 * @return db return code
 */
ds_return_code_t cps_api_transaction_init(cps_api_transaction_params_t *req, cps_api_instance_t db_type);
/**
 ...
 * @return db return code
 */
ds_return_code_t cps_api_transaction_close(cps_api_transaction_params_t *req);
 ...
 */
ds_return_code_t cps_api_set(cps_api_transaction_params_t * trans,
 ...
 * @return standard db return code
 */
ds_return_code_t cps_api_create(cps_api_transaction_params_t * trans,
		cps_api_object_t object);
 ...
 * @return standard db return code
 */
ds_return_code_t cps_api_delete(cps_api_transaction_params_t * trans,
		cps_api_object_t object);
 ...
 * @return db_return_code_t
 */
ds_return_code_t cps_api_commit(cps_api_transaction_params_t * param);
...
typedef struct {
    ...
    cps_obj_key_t key;
    ds_return_code_t (*db_read_function) (void * context, cps_api_get_params_t * param, size_t key_ix); //! the read db function
    ds_return_code_t (*db_write_function)(void * context, cps_api_transaction_params_t * param, size_t index_of_element_being_updated); //! the set db function
    ds_return_code_t (*db_rollback_function)(void * context, cps_api_transaction_params_t * param, size_t index_of_element_being_updated); //! the set db function
 ...
 * @return standard db return code
 */
ds_return_code_t cps_api_register(cps_api_registration_functions_t * reg);
