...
static ds_return_code_t _cps_api_event_service_client_connect(cps_api_event_service_handle_t * handle) {
	return std_server_client_connect((std_event_client_handle*)handle,HAL_EVENT_SERVICE_PATH) == STD_ERR_OK ?
			ds_ret_code_OK : ds_ret_code_ERR;
}

static ds_return_code_t _cps_api_event_service_client_register(cps_api_event_service_handle_t *handle,
...
static ds_return_code_t _cps_api_event_service_publish_msg(cps_api_event_service_handle_t handle,
...
static ds_return_code_t _cps_api_event_service_client_deregister(cps_api_event_service_handle_t handle) {
	return ds_ret_code_OK;
}

static ds_return_code_t _cps_api_wait_for_event(cps_api_event_service_handle_t handle,
		cps_api_event_header_t *msg) {

	std_event_msg_t *std_msg = std_client_allocate_msg(msg->max_data_len+sizeof(std_event_msg_t));
	if (std_msg==NULL) return ds_ret_code_ERR;
