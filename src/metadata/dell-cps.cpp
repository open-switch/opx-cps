...
{ { cps_api_obj_CAT_CPS,CPS_OBJECT_GROUP,CPS_OBJECT_GROUP_USER_TIMESTAMP_NSEC }, 3, CPS_OBJECT_GROUP_USER_TIMESTAMP_NSEC},
...
{ "cps/object-group/user-timestamp-nsec", "This is a user-defined timestamp in nano-seconds that can be inserted into an object.", false, CPS_CLASS_ATTR_T_LEAF, CPS_CLASS_DATA_TYPE_T_UINT64 },
