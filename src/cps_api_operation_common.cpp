...
ds_return_code_t cps_api_register(cps_api_registration_functions_t * reg) {
    ...
    if (inst>=get().size()) return ds_ret_code_ERR;
...
ds_return_code_t cps_api_get(cps_api_get_params_t * param) {
    ...
    ds_return_code_t rc = ds_ret_code_ERR;
    size_t ix = 0;
...
ds_return_code_t cps_api_get_request_init(cps_api_get_params_t *req) {
    ...
    if (req->object==NULL) return ds_ret_code_ERR;
    return ds_ret_code_OK;
}
...
static ds_return_code_t ds_tran_op_append(cps_api_transaction_params_t * param,
