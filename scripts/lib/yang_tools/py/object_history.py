...
class YangHistory_ConfigFile_v2:
    ...
    def get(self):
        ...
        try:
            d['global']['range-start'] = long(_config.get('global','range-start'))
...
if __name__ == '__main__':
    ...
    __context = {}
    __context['history']={}
    __context['history']['category'] = YangHistory_CategoryParser(__context,'/tmp/category.txt')
    ...
    __added_values = []
    for i in range(0,30):
        __added_values.append(('entry_'+str(i), _category_test.get_category('entry_'+str(i))))
    ...
    _hist = YangHistory_HistoryFile(__context,'/tmp/dell-base-cps.yhist','cps_api_obj_CAT_CPS');
